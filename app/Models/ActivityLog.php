...
class ActivityLog extends Model
{
    ...
    protected $fillable = [
        'user_id', 'account_id', 'server_id', 'action',
    ...
    public function actionIcon(): string
    {
        return match (explode('.', $this->action)[0] ?? '') {
            'domain', 'subdomain' => 'M21 12a9 9 0 01-9 9m9-9a9 9 0 00-9-9m9 9H3m9 9a9 9 0 01-9-9m9 9c1.657 0 3-4.03 3-9s-1.343-9-3-9m0 18c-1.657 0-3-4.03-3-9s1.343-9 3-9m-9 9a9 9 0 019-9',
            ...
            'account' => 'M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0z',
            'service' => 'M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15',
    ...
    {
        $verb = explode('.', $this->action)[1] ?? '';
        return match ($verb) {
            'created', 'added', 'issued', 'imported', 'generated', 'login' => 'text-green-600 bg-green-100',
            'deleted', 'removed'  => 'text-red-600 bg-red-100',
            'updated', 'changed', 'renewed', 'toggled', 'restarted' => 'text-indigo-600 bg-indigo-100',
