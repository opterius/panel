    ...
    @if($atLimit)
        <div class="mb-6 bg-amber-50 border border-amber-200 text-amber-700 px-4 py-3 rounded-lg text-sm flex items-center justify-between">
            <div class="flex items-center space-x-2">
                ...
                <span>Account limit reached ({{ $currentAccounts }}/{{ $maxAccounts }}). <a href="https://opterius.com" target="_blank" class="underline font-medium">Upgrade your license</a> to create more accounts.</span>
            </div>
        </div>
    @endif
                            ...
                            <div>
                                <div class="flex items-center space-x-2">
                                    ...
                                    @if($account->suspended)
                                        <span class="inline-flex items-center px-1.5 py-0.5 rounded text-xs font-medium bg-red-100 text-red-700">Suspended</span>
                                    @endif
                                </div>
