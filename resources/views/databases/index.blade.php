                    ...
                    <div class="flex items-center justify-between px-6 py-4 hover:bg-gray-50 transition">
                        ...
                        <div class="flex items-center space-x-3">
                            ...
                            <x-delete-modal
                                ...
                                message="This will permanently remove {{ $database->name }} and its user from the server."
                                :confirm-password="true">
                                <x-slot name="trigger">
                                    <button type="button" class="text-gray-400 hover:text-red-600 transition" title="Delete database">
