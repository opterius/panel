<x-user-layout>
    ...
    <div class="flex flex-wrap gap-3 mb-6">
        @if(config('opanel.phpmyadmin_sso_secret') && $database->encrypted_password)
        ...
        @else
            @php
                $pmaBase = str_replace('SERVER_IP', $database->account->server->ip_address, config('opanel.phpmyadmin_url', 'https://SERVER_IP:8081'));
            @endphp
            ...
            @if(config('opanel.phpmyadmin_sso_secret'))
