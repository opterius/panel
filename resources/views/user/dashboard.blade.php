    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="lg:col-span-2">
          <div class="bg-white rounded-xl shadow-sm p-6">
            ...
            {{-- Domain --}}
            <div class="mb-6">
                <h3 class="text-xs font-semibold text-gray-400 uppercase tracking-wider mb-3 px-1">Domain</h3>
                <div class="grid grid-cols-4 sm:grid-cols-5 md:grid-cols-6 gap-1">
                    <a href="{{ route('user.domains.index') }}" class="group flex flex-col items-center p-3 rounded-xl hover:bg-indigo-50 transition">
                        ...
                        <span class="mt-2 text-xs font-medium text-gray-600 group-hover:text-indigo-700">Domain</span>
                    </a>
                    ...
                    <a href="{{ route('user.aliases.index') }}" class="group flex flex-col items-center p-3 rounded-xl hover:bg-amber-50 transition">
                        ...
                        <span class="mt-2 text-xs font-medium text-gray-600 group-hover:text-amber-700">Aliases</span>
                    </a>
                    <a href="{{ route('user.redirects.index') }}" class="group flex flex-col items-center p-3 rounded-xl hover:bg-pink-50 transition">
                        ...
                        <span class="mt-2 text-xs font-medium text-gray-600 group-hover:text-pink-700">Redirects</span>
                    </a>
                </div>
            </div>
            ...
            {{-- Files --}}
            <div class="mb-6">
                <h3 class="text-xs font-semibold text-gray-400 uppercase tracking-wider mb-3 px-1">Files</h3>
                <div class="grid grid-cols-4 sm:grid-cols-5 md:grid-cols-6 gap-1">
            ...
            {{-- Databases --}}
            <div class="mb-6">
                <h3 class="text-xs font-semibold text-gray-400 uppercase tracking-wider mb-3 px-1">Databases</h3>
                <div class="grid grid-cols-4 sm:grid-cols-5 md:grid-cols-6 gap-1">
            ...
            {{-- Email --}}
            <div class="mb-6">
                <h3 class="text-xs font-semibold text-gray-400 uppercase tracking-wider mb-3 px-1">Email</h3>
                <div class="grid grid-cols-4 sm:grid-cols-5 md:grid-cols-6 gap-1">
            ...
            {{-- Software --}}
            <div class="mb-6">
                <h3 class="text-xs font-semibold text-gray-400 uppercase tracking-wider mb-3 px-1">Software</h3>
                <div class="grid grid-cols-4 sm:grid-cols-5 md:grid-cols-6 gap-1">
            ...
            <div>
                ...
                <div class="grid grid-cols-4 sm:grid-cols-5 md:grid-cols-6 gap-1">
                    <a href="{{ route('user.php.index') }}" class="group flex flex-col items-center p-3 rounded-xl hover:bg-indigo-50 transition">
                        ...
                        <span class="mt-2 text-xs font-medium text-gray-600 group-hover:text-indigo-700">PHP Version</span>
                    </a>
        ...
        <div class="space-y-5">
            ...
            @if($primaryAccount)
                <div class="bg-white rounded-xl shadow-sm p-5">
                    ...
                    <div class="mb-4">
                        <div class="flex items-center justify-between text-sm mb-1.5">
                            ...
                            <span class="text-gray-500">
                                ...
                                @if($diskQuota > 0) / {{ $diskQuota >= 1024 ? number_format($diskQuota / 1024, 1) . ' GB' : $diskQuota . ' MB' }} @else / Unlimited @endif
                            </span>
                        </div>
                    ...
                    <div class="grid grid-cols-2 gap-3 pt-3 border-t border-gray-100">
                        <div class="bg-gray-50 rounded-lg p-3 text-center">
                            ...
                            <div class="text-xs text-gray-500">{{ $myDomains->count() === 1 ? 'Domain' : 'Domains' }}</div>
                        </div>
                        <div class="bg-gray-50 rounded-lg p-3 text-center">
                            <div class="text-lg font-bold text-gray-900">{{ $mySubdomains }}</div>
                            <div class="text-xs text-gray-500">Subdomains</div>
                        </div>
                        <div class="bg-gray-50 rounded-lg p-3 text-center">
                        ...
                        <div class="bg-gray-50 rounded-lg p-3 text-center">
                            ...
                            <div class="text-xs text-gray-500">Email Accounts</div>
                        </div>
                        <div class="bg-gray-50 rounded-lg p-3 text-center">
                            <div class="text-lg font-bold text-gray-900">{{ $myCerts }}</div>
                            <div class="text-xs text-gray-500">SSL Certificates</div>
                        </div>
                        <div class="bg-gray-50 rounded-lg p-3 text-center">
                            <div class="text-lg font-bold text-gray-900">{{ $myCrons }}</div>
                            <div class="text-xs text-gray-500">Cron Jobs</div>
                        </div>
                    </div>
                </div>
                ...
                @if($stats)
                    <div class="bg-white rounded-xl shadow-sm p-5">
                        <h4 class="text-sm font-semibold text-gray-800 mb-4">Storage Breakdown</h4>
                        <div class="space-y-3">
                ...
                @if($primaryAccount->package)
                    <div class="bg-white rounded-xl shadow-sm p-5">
                        <h4 class="text-sm font-semibold text-gray-800 mb-3">Package</h4>
