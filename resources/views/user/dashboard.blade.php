          ...
          <div class="bg-white rounded-xl shadow-sm p-6">
            ...
            <div class="mb-6">
                ...
                <div class="grid grid-cols-4 sm:grid-cols-5 md:grid-cols-6 gap-1">
                    ...
                    <a href="{{ str_replace('SERVER_IP', $myDomains->first()?->account?->server?->ip_address ?? 'localhost', config('opanel.webmail_url', 'https://SERVER_IP:8080')) }}" target="_blank" class="group flex flex-col items-center p-3 rounded-xl hover:bg-orange-50 transition">
            ...
            <div class="mb-6">
                ...
                <div class="grid grid-cols-4 sm:grid-cols-5 md:grid-cols-6 gap-1">
                    ...
                    <a href="{{ route('user.logs.index') }}" class="group flex flex-col items-center p-3 rounded-xl hover:bg-slate-50 transition">
                        <svg class="w-9 h-9 text-slate-500" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M9 17v-2m3 2v-4m3 4v-6m2 10H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/></svg>
                        <span class="mt-2 text-xs font-medium text-gray-600 group-hover:text-slate-700">Live Logs</span>
                    </a>
                    <a href="{{ route('user.staging.index') }}" class="group flex flex-col items-center p-3 rounded-xl hover:bg-violet-50 transition">
                        <svg class="w-9 h-9 text-violet-500" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M8 9l3 3-3 3m5 0h3M5 20h14a2 2 0 002-2V6a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"/></svg>
                        <span class="mt-2 text-xs font-medium text-gray-600 group-hover:text-violet-700">Staging</span>
                    </a>
                </div>
            </div>
