<aside class="w-64 bg-gray-900 text-gray-300 flex flex-col shrink-0">
        ...
        <div class="px-3 py-3 border-b border-gray-800"
            ...
            <div x-show="open" x-collapse class="mt-2">
                <div class="relative mb-2">
                    ...
                    {{-- name="search" + autocomplete="off" is ignored by Chrome's password managers; the cocktail below is what actually defeats them. --}}
                    <input type="search" x-ref="acctSearch" x-model="search"
                        placeholder="Search account…"
                        autocomplete="new-password"
                        autocorrect="off" autocapitalize="off" spellcheck="false"
                        data-lpignore="true" data-1p-ignore data-form-type="other" data-bwignore
                        name="acct-filter-{{ uniqid() }}"
                        class="w-full bg-gray-800 border-0 rounded-md pl-8 pr-2 py-1.5 text-sm text-gray-200 placeholder-gray-500 focus:ring-1 focus:ring-indigo-500">
                </div>
    ...
    <div class="px-4 py-3 border-t border-gray-800 text-xs text-gray-500">
        <div>OPanel v{{ config('opanel.version', '1.0.0') }}</div>
    </div>
</aside>
